...
//     version 1.11.1
//     from Assets/Characters/InputSystem_Player2.inputactions
//
...
public partial class @InputSystem_Player2: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputSystem_Player2()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputSystem_Player2"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@InputSystem_Player2()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, InputSystem_Player2.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputSystem_Player2.UI.Disable() has not been called.");
    }
    ...
    {
        private @InputSystem_Player2 m_Wrapper;
        public PlayerActions(@InputSystem_Player2 wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @InputSystem_Player2 m_Wrapper;
        public UIActions(@InputSystem_Player2 wrapper) { m_Wrapper = wrapper; }
